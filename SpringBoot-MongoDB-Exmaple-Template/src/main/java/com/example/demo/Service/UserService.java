...
public class UserService {
    //Todo:
    //  1. Annotiere die Klasse, um aus diesem eine Service Klasse zu erzeugen
    //  ---
    //  Implementiere folgende Funktionen durch die Nutzung der Funktionen im Interface UserRepository
